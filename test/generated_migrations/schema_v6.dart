...
class Chapters extends Table with TableInfo<Chapters, ChaptersData> {
  ...
  late final GeneratedColumn<int> isVolume = GeneratedColumn<int>(
    ...
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 0 CHECK (is_volume IN (0, 1))',
    defaultValue: const CustomExpression('0'),
  );
  ...
  late final GeneratedColumn<int> isPay = GeneratedColumn<int>(
    ...
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 0 CHECK (is_pay IN (0, 1))',
    defaultValue: const CustomExpression('0'),
  );
  late final GeneratedColumn<String> variable = GeneratedColumn<String>(
    'variable',
...
class ChaptersData extends DataClass implements Insertable<ChaptersData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['is_volume'] = Variable<int>(isVolume);
    map['is_vip'] = Variable<int>(isVip);
    map['is_pay'] = Variable<int>(isPay);
    if (!nullToAbsent || variable != null) {
      map['variable'] = Variable<String>(variable);
    }
    return map;
...
class ChaptersCompanion extends UpdateCompanion<ChaptersData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (isVolume.present) {
      map['is_volume'] = Variable<int>(isVolume.value);
    }
    if (isVip.present) {
      map['is_vip'] = Variable<int>(isVip.value);
    }
    if (isPay.present) {
      map['is_pay'] = Variable<int>(isPay.value);
    }
    if (variable.present) {
      map['variable'] = Variable<String>(variable.value);
    }
