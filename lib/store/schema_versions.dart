...
final class Schema3 extends i0.VersionedSchema {
  ...
  late final Shape11 sourceCookies = Shape11(
    source: i0.VersionedTable(
      entityName: 'source_cookies',
      withoutRowId: false,
      isStrict: false,
      tableConstraints: ['PRIMARY KEY(domain, name)'],
      columns: [_column_77, _column_1, _column_76, _column_78],
      attachedDatabase: database,
    ),
    alias: null,
  );
  late final Shape12 sourceEntries = Shape12(
    source: i0.VersionedTable(
      entityName: 'source_entries',
      withoutRowId: false,
      isStrict: false,
      tableConstraints: ['PRIMARY KEY(source_ref, "key")'],
      columns: [_column_79, _column_75, _column_80, _column_81],
      attachedDatabase: database,
    ),
    alias: null,
  );
...
class Shape11 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get value =>
      columnsByName['value']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get writerRef =>
      columnsByName['writer_ref']! as i1.GeneratedColumn<String>;
}
...
final class Schema4 extends i0.VersionedSchema {
  ...
  late final Shape13 sourceTlsExceptions = Shape13(
    source: i0.VersionedTable(
      entityName: 'source_tls_exceptions',
      withoutRowId: false,
      isStrict: false,
      tableConstraints: ['PRIMARY KEY(source_ref, host)'],
      columns: [_column_79, _column_82],
      attachedDatabase: database,
    ),
    alias: null,
  );
...
final class Schema5 extends i0.VersionedSchema {
  ...
  late final Shape14 sourceEntries = Shape14(
    source: i0.VersionedTable(
      entityName: 'source_entries',
      withoutRowId: false,
      isStrict: false,
      tableConstraints: ['PRIMARY KEY(source_ref, "key")'],
      columns: [_column_79, _column_75, _column_80, _column_81, _column_83],
      attachedDatabase: database,
    ),
    alias: null,
  );
...
class Shape14 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<int> get expiresAt =>
      columnsByName['expires_at']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get writtenAt =>
      columnsByName['written_at']! as i1.GeneratedColumn<int>;
}
...
final class Schema6 extends i0.VersionedSchema {
  ...
  late final Shape15 chapters = Shape15(
    source: i0.VersionedTable(
      entityName: 'chapters',
      withoutRowId: false,
      isStrict: false,
...
class Shape15 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<int> get isVolume =>
      columnsByName['is_volume']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get isVip =>
      columnsByName['is_vip']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get isPay =>
      columnsByName['is_pay']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get variable =>
      columnsByName['variable']! as i1.GeneratedColumn<String>;
}
